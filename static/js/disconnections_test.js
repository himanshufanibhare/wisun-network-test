...
function updateResultsTable(deviceResult) {
    ...
    const rowHTML = `
                                ...
                                <td class="retest">
                                    <button class="btn btn-sm ${finalButtonClass}" id="retest_${deviceId}" onclick="retestDevice('${deviceResult.ip}', '${deviceResult.label}', '${deviceId}')" ${disabledAttr} ${dataSkippedAttr}>
